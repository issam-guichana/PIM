...
import 'second_intro_screen.dart'; // Assurez-vous que le chemin est correct
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [
                        Color(0xFF3ED0FA), // Teal
                        Color(0xFFB041F0), // Violet
                      ],
                  ...
                  child: Container(
                    margin: const EdgeInsets.all(2), // Épaisseur du contour
                    decoration: BoxDecoration(
                      color: Colors.white, // Intérieur de la carte
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              "Are you living with Alzheimer’s or caring for someone who is?",
                          ...
                          // Bouton de navigation animé (Hero)
                          Hero(
  tag: 'introArrow',
  child: InkWell(
      ...
      child: Container(
        ...
        child: Center(
          child: ShaderMask(
            ...
            child: const Icon(
              Icons.arrow_forward,
              color: Colors.white, // Couleur "écrasée" par le ShaderMask
              size: 20,
            ),
          ),
        ),
