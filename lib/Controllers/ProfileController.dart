...
class ProfileProvider extends ChangeNotifier {
  ...
  Future<void> fetchUserProfile(String userId) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.137.27:3000/user/$userId'),
  ...
  try {
    ...
    final response = await http.patch( // ✅ Changer PUT -> PATCH
      Uri.parse('http://192.168.137.27:3000/user/update'), // ✅ Enlever l'ID de l'URL
      headers: {'Content-Type': 'application/json'},
      body: json.encode({
...
Future<bool> verifyOtp(String email, String otp) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.137.27:3000/user/verify-otp'),
      headers: {'Content-Type': 'application/json'},
...
Future<bool> sendOtp(String email) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.137.27:3000/user/send-otp'),
      headers: {'Content-Type': 'application/json'},
  ...
  Future<bool> resendOtp(String email) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.137.27:3000/user/resend-otp'), // ✅ Correct API route
        headers: {'Content-Type': 'application/json'},
        body: json.encode({"email": email}),
      );
  ...
  try {
    ...
    final response = await http.patch( // ✅ Change to PATCH
      Uri.parse('http://192.168.137.27:3000/user/update-password'), 
      headers: {'Content-Type': 'application/json'},
  ...
  try {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.137.27:3000/user/forget-password'),
      headers: {'Content-Type': 'application/json'},
