...
class ProfileProvider extends ChangeNotifier {
  ...
  Future<void> fetchUserProfile(String userId) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/$userId'),
  ...
  try {
    ...
    final response = await http.patch( // ✅ Changer PUT -> PATCH
      Uri.parse( 'https://6491-196-234-27-227.ngrok-free.app/user/update'), // ✅ Enlever l'ID de l'URL
      headers: {'Content-Type': 'application/json'},
      body: json.encode({
...
Future<bool> verifyOtp(String email, String otp) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/verify-otp'),
      headers: {'Content-Type': 'application/json'},
...
Future<bool> sendTemporaryPassword(String email) async {
  try {
    final response = await http.post(
      Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/forget-password'),
      headers: {'Content-Type': 'application/json'},
...
Future<bool> resendOtp(String email) async {
    try {
        ...
        final response = await http.post(
            Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/resend-otp'), // ✅ Correct API route
            headers: {'Content-Type': 'application/json'},
            body: json.encode({"email": email}),
        );
  ...
  try {
    ...
    final response = await http.patch( // ✅ Change to PATCH
      Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/update-password'), // ✅ Ensure correct API endpoint
      headers: {'Content-Type': 'application/json'},
  ...
  Future<bool> _loginUser(BuildContext context, String email, String password) async {
    try {
      final response = await http.post(
        Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/login'),
        headers: {'Content-Type': 'application/json'},
...
Future<bool> verifyTemporaryPassword(String email, String tempPassword) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('https://6491-196-234-27-227.ngrok-free.app/user/verify-temp-password'),
      headers: {'Content-Type': 'application/json'},
